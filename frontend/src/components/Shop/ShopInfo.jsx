   ...
   <>
   {
    isLoading  ? (
      ...
      <div className="w-full pt-10">
        <div className="w-full flex item-center justify-center">
          <img
            ...
            alt=""
            className="w-[150px] h-[150px] object-cover rounded-full border-2 border-[#1F1EFB]"
          />
        </div>
        <h3 className="text-center py-4 text-[20px]">{data.name}</h3>
        <p className="text-[16px] text-gray-600 p-[10px] flex items-center">
          {data.description}
        </p>
      </div>
      <div className="p-3">
      ...
      <div className="p-3">
        ...
        <h4 className="text-gray-600">{products && products.length}</h4>
      </div>
      <div className="p-3">
